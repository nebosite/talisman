...
var TalismanOptions_1 = require("./TalismanOptions");
//------------------------------------------------------------------------------
// main
//------------------------------------------------------------------------------
function main(argv) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            try {
                options = new TalismanOptions_1.TalismanOptions(argv);
                if (options.showHelp) {
                    showHelp(options);
                    return [2 /*return*/, 0];
                }
                if (options.badArgs.length > 0) {
                    ...
                    options.badArgs.forEach(function (arg) { return console.log("  " + arg); });
                    process.exit();
                }
                console.log("hi");
                return [2 /*return*/, 0];
